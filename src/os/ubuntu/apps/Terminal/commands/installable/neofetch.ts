...
export const neofetch: CommandHandler = async (_args, env, streams) => {
  ...
  const output = [
    ...
    `    \x1b[31m.ossssssssssssssssssdMMMNysssso.\x1b[0m       \x1b[33mHost\x1b[0m: ${config.deviceModel}`,
    ...
    `\x1b[31m+sssshhhyNMMNyssssssssssssyNMMMysssssss+\x1b[0m   \x1b[33mCPU\x1b[0m: ${config.processor}`,
    `\x1b[31m.ssssssssdMMMNhsssssssssshNMMMdssssssss.\x1b[0m   \x1b[33mMemory\x1b[0m: 4301MiB / ${config.memory.replace(' GiB', '00MiB')}`,
