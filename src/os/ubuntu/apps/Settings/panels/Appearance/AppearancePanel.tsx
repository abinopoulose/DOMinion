...
export function AppearancePanel() {
  ...
  return (
    <SettingsPanelWrapper title="Appearance">
      <div className="ubuntu-settings-section-title" style={{ padding: '0 8px 8px', fontSize: '13px', fontWeight: 'bold', color: 'var(--color-text-secondary)', textTransform: 'uppercase' }}>
        Style
      </div>
      ...
      <div className="appearance-background-header">
        <div className="ubuntu-settings-section-title" style={{ fontSize: '13px', fontWeight: 'bold', color: 'var(--color-text-secondary)', textTransform: 'uppercase' }}>
          Background
        </div>
