...
export function WifiPanel() {
  const toggleSwitch = (
    <div className="ubuntu-settings-toggle disabled">
    ...
    <SettingsPanelWrapper title="Wi-Fi" rightHeaderContent={toggleSwitch}>
      <div className="ubuntu-wifi-empty-state">
        <div className="ubuntu-wifi-empty-icon">
          {/* Simple CSS-based icon representing disabled Wi-Fi */}
        ...
        <h3 className="ubuntu-wifi-empty-title">No Wi-Fi Adapter Found</h3>
