    ...
    <SettingsPanelWrapper>
      ...
      {isTestOpen && (
        <div style={{ position: 'fixed', top: 0, left: 0, right: 0, bottom: 0, backgroundColor: 'rgba(0,0,0,0.5)', display: 'flex', alignItems: 'center', justifyContent: 'center', zIndex: 9999 }} onClick={() => setIsTestOpen(false)}>
          <div style={{ width: '420px', backgroundColor: '#fff', borderRadius: '12px', boxShadow: '0 10px 30px rgba(0,0,0,0.2)', display: 'flex', flexDirection: 'column', overflow: 'hidden', animation: 'fadeInPanel 0.2s ease-out' }} onClick={(e) => e.stopPropagation()}>
              ...
              <div style={{ position: 'relative', width: '260px', height: '260px', borderRadius: '50%', backgroundColor: 'rgba(0,0,0,0.05)', display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
                ...
                <button 
                  ...
                  style={{ 
                    ...
                    backgroundColor: activeSpeaker === 'left' ? 'var(--color-accent)' : '#fff', 
                ...
                <button 
                  ...
                  style={{ 
                    ...
                    backgroundColor: activeSpeaker === 'right' ? 'var(--color-accent)' : '#fff',
