...
/**
 * GNOME-style "Delete Permanently?" confirmation dialog.
 */
      ...
      >
        ...
        <div style={{ display: 'flex', alignItems: 'center', gap: '14px' }}>
          <div style={{
            ...
            height: 48,
            borderRadius: '50%',
            background: 'color-mix(in srgb, #cc0000 15%, transparent)',
            display: 'flex',
            alignItems: 'center',
            justifyContent: 'center',
            flexShrink: 0,
          }}>
            <svg viewBox="0 0 24 24" width="26" height="26" fill="#cc0000">
